...
FPInterfaceDesc thebhkRigidBodyInterface(
   ...
   enums,
      bhkRigidBodyInterface::enum_material, 85,
         "Stone", 0,
         "Cloth", 1,
         "Dirt", 2,
         "Glass", 3,
         ...
         "Elevator", 30,
		 //skyrim
	"SKY_MAT_LIGHT_WOOD", 31, 
	"SKY_MAT_BROKEN_STONE", 32,
	"SKY_MAT_SNOW", 33,
	"SKY_MAT_GRAVEL", 34,
	"SKY_MAT_MATERIAL_CHAIN_METAL", 35,
	"SKY_MAT_WOOD", 36,
	"SKY_MAT_SKIN", 37,
	"SKY_MAT_BARREL", 38,
	"SKY_MAT_MATERIAL_CERAMIC_MEDIUM", 39,
	"SKY_MAT_MATERIAL_BASKET", 40,
	"SKY_MAT_ICE", 41,
	"SKY_MAT_STAIRS_STONE", 42,
	"SKY_MAT_MATERIAL_BLADE_1HAND", 43,
	"SKY_MAT_WATER", 44,
	"SKY_MAT_UNKNOWN_1028101969", 45,
	"SKY_MAT_MATERIAL_BOOK", 46, 
	"SKY_MAT_SOLID_METAL", 47,
	"SKY_MAT_MATERIAL_AXE_1HAND", 48,
	"SKY_MAT_UNKNOWN_1440721808", 49,
	"SKY_MAT_STAIRS_WOOD", 50,
	"SKY_MAT_MUD", 51,
	"SKY_MAT_STAIRS_SNOW", 52,
	"SKY_MAT_UNKNOWN_", 53,
	"SKY_MAT_UNKNOWN_", 54,
	"SKY_MAT_MATERIAL_BOWS_STAVES", 55,
	"SKY_MAT_MATERIAL_WOOD_AS_STAIRS", 56,
	"SKY_MAT_GRASS", 57,
	"SKY_MAT_MATERIAL_BOULDER_LARGE", 58,
	"SKY_MAT_MATERIAL_STONE_AS_STAIRS", 59,
	"SKY_MAT_MATERIAL_BLADE_2HAND", 60,
	"SKY_MAT_MATERIAL_BOTTLE_SMALL", 61,
	"SKY_MAT_SAND", 62,
	"SKY_MAT_HEAVY_METAL", 63,
	"SKY_MAT_DRAGON", 64,
	"SKY_MAT_MATERIAL_BLADE_1HAND_SMALL", 65,
	"SKY_MAT_MATERIAL_SKIN_SMALL", 66,
	"SKY_MAT_STAIRS_BROKEN_STONE", 67,
	"SKY_MAT_MATERIAL_SKIN_LARGE", 68,
	"SKY_MAT_ORGANIC", 69,
	"SKY_MAT_MATERIAL_BONE", 70,
	"SKY_MAT_HEAVY_WOOD", 71,
	"SKY_MAT_MATERIAL_CHAIN", 72,
	"SKY_MAT_DIRT", 73,
	"SKY_MAT_MATERIAL_ARMOR_LIGHT", 74,
	"SKY_MAT_MATERIAL_SHIELD_LIGHT", 75,
	"SKY_MAT_MATERIAL_COIN", 76,
	"SKY_MAT_MATERIAL_SHIELD_HEAVY", 78,
	"SKY_MAT_MATERIAL_ARMOR_HEAVY", 79,
	"SKY_MAT_MATERIAL_ARROW", 80,
	"SKY_MAT_GLASS", 81,
	"SKY_MAT_STONE", 82,
	"SKY_MAT_CLOTH", 83,
	"SKY_MAT_MATERIAL_BLUNT_2HAND", 84,
	"SKY_MAT_MATERIAL_BOULDER_MEDIUM", 85,
